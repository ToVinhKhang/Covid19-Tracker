...
$("#txtAboutData").change(function(){
	...
	if(target=="VaccineDetails"){
		$("#imgVaccineDetails").attr("src", "https://cms.wellcome.org/sites/default/files/styles/image_full_hi/public/2021-01/FINAL_ExplainerThumbnails_Ex9_What_Different_Types_Of_Covid_Vaccine_Are_There-1600x900.png?itok=uHtvnnMM");
